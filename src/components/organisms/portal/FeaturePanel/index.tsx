export function PortalFeaturePanel() {
  return (
    <section className='bg-slate-50 dark:bg-slate-900' id='feature'>
      <div className='py-6 sm:py-8 lg:py-12'>
        <div className='mx-auto max-w-screen-2xl px-4 md:px-8'>
          {/* <!-- text - start --> */}
          <div className='mb-10 md:mb-16'>
            <h2 className='mb-4 text-center text-2xl font-bold md:mb-6 lg:text-3xl'>主な機能</h2>
          ...
          <div className='grid gap-8 sm:grid-cols-2 md:gap-12 xl:grid-cols-3 xl:gap-16'>
            ...
            <div className='flex gap-4 md:gap-6'>
              ...
              <div>
                ...
                <a
                  href='#'
                  className='font-bold text-primary transition duration-100 hover:text-teal-600 active:text-teal-700'
                >
                  More
                </a>
              </div>
